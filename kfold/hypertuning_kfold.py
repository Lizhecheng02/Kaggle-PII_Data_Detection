...
train3 = pd.read_json("./kaggle_dataset/rewrite_1k_more_name.json")
train4 = pd.read_json("./kaggle_dataset/Fake_data_same_nb_1000_0.json")
train5 = pd.read_json("./kaggle_dataset/znf_no_label_2k_0223.json")
...
# I-URL_PERSONAL
weights[label2id["I-URL_PERSONAL"]] = weights[label2id["I-URL_PERSONAL"]]
