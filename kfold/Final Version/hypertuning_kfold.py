...
print(f"fold {fold}")
# load dataset
valid_df = pd.read_json(f"../kaggle_dataset/test_fold_{fold}.json")

train1 = pd.read_json(f"../kaggle_dataset/train_fold_{fold}.json")
train2 = pd.read_json("../kaggle_dataset/nb_mixtral-8x7b-v1.json")
train3 = pd.read_json(
    "../kaggle_dataset/rewrite/rewrite_1k_more_name_en_name.json")
...
train5 = pd.read_json(
    "../kaggle_dataset/znf_nb_lzc_general_topic_2k_0219_gpt.json")
train5 = train5.sample(frac=0.25, random_state=777).reset_index(
    drop=True)  # 2000 * 0.25

train6 = pd.read_json("../kaggle_dataset/rewrite/have_label_replace_400.json")
# train6 = train6.sample(frac=0.25, random_state=777).reset_index(drop = True)

train7 = pd.read_json("../kaggle_dataset/Fake_data_fix_prompt_500.json")
# for i in range(1,4):
...
# train9 = train9.sample(frac=0.75, random_state=777).reset_index(drop = True)

train10 = pd.read_json(
    "../kaggle_dataset/lzc_1k_0223_newdis_newprompt_gpt.json")
