#wandb sweep --project PII config_v4_pii_model.yaml
...
TRAINING_MODEL_PATH = "lakshyakh93/deberta_finetuned_pii"

# load dataset
valid_df = pd.read_json("../kaggle_dataset/test_split.json")

train1 = pd.read_json("../kaggle_dataset/train_split.json")
#train2 = pd.read_json("../kaggle_dataset/Fake_data_fix_prompt_500.json")
train3 = pd.read_json("../kaggle_dataset/nb_mixtral-8x7b-v1.json")
#train4 = pd.read_json("../kaggle_dataset/Fake_data_fix_prompt_500_1.json")

#train_more_data = pd.read_json("../kaggle_dataset/Fake_data_fix_prompt_500_2.json")
...
train_df = pd.concat([train1, train3])# , 
...
data1 = json.load(open("../kaggle_dataset/Fake_data_fix_prompt_500_1.json"))
...
def main():
    ...
    with open("./config_v4_pii_model.yaml") as file:
